...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject HealAllHp;
    ...
    {
        if (Controller.money < costs[2])
        {
            StartCoroutine(WarningPaanel());
            Warning.text = "вам нехватает : " + (Controller.money - costs[2]) + " денег";
        }
        else
        {
            for (int i = 0; i < enemies.Length; i++)
